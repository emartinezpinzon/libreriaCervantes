...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    private static final String OCURRIO_UN_ERROR_FAVOR_CONTACTAR_AL_ADMINISTRADOR = "Ha ocurrido un error, por favor contacta al administrador :)";
    ...
    public ManejadorError() {
        ...
        CODIGOS_ESTADO.put(ExcepcionNoRegistrado.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
